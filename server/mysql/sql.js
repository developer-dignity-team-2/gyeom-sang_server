module.exports = {
  ...
  messageList: `select t1.*, (select nickname from user where user.email = t1.sender_email) as sender_nickname, (select nickname from user where user.email = t1.receiver_email) as receiver_nickname from message t1`,
