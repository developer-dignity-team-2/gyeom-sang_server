module.exports = {
  ...
  userDelete: `delete from user where email = ?`,
  ...
  scoreDelete: `delete from user_question_score_aggregation where email = ?`,
  ...
  babsangEndList: `select * from dining_table where dining_status = 0 and recruit_end_date <= ?;`,
  ...
  babsangAppliedList: `select t1.*, (select temp2.active_yn from dining_table temp1 inner join user_favorites temp2 on temp1.id = temp2.dining_table_id where temp2.user_email = ? and temp1.id = t2.dining_table_id order by temp2.create_date desc limit 1) as active_yn, (select u.nickname from user u where u.email = t1.host_email) as host_nickname, (select u.profile_image from user u where u.email = t1.host_email) as host_profile_image from dining_table t1 inner join dining_table_spoons t2 on t1.id = t2.dining_table_id where t2.spoon_email = ? and t2.apply_yn = 'Y'`,
  babsangCreatedList: `select t1.*, (select temp2.active_yn from dining_table temp1 inner join user_favorites temp2 on temp1.id = temp2.dining_table_id where temp2.user_email = ? and temp1.id = t1.id order by temp2.create_date desc limit 1) as active_yn, (select u.nickname from user u where u.email = t1.host_email) as host_nickname, (select u.profile_image from user u where u.email = t1.host_email) as host_profile_image from dining_table t1 where host_email = ?`,
  babsangSelectedList: `select t1.*, (select temp2.active_yn from dining_table temp1 inner join user_favorites temp2 on temp1.id = temp2.dining_table_id where temp2.user_email = ? and temp1.id = t2.dining_table_id order by temp2.create_date desc limit 1) as active_yn, (select u.nickname from user u where u.email = t1.host_email) as host_nickname, (select u.profile_image from user u where u.email = t1.host_email) as host_profile_image from dining_table t1 inner join dining_table_spoons t2 on t1.id = t2.dining_table_id where t2.spoon_email = ? and t2.selected_yn = 'Y' and t2.apply_yn = 'Y'`,
